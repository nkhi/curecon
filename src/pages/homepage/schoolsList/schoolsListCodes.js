export const AfricanSubregions = [
...
export const AmericanSubregions = [
  { name: "North America", 
...
export const EuropeanSubregions = [
  { name: "Western Europe", 
...
export const OceanicSubregions = [
  { name: "Australia", 
